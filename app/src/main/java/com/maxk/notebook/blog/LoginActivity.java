                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(LoginActivity.this, "관리자 확인이 되지 않습니다.", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        } else {
            Toast.makeText(LoginActivity.this, "관리자 이메일 주소와 암호를 입력바랍니다 ", Toast.LENGTH_LONG).show();
        }
    }
        ...
        if (auth.getCurrentUser() != null) {
            ...
            databaseRefUsers.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (true || dataSnapshot.hasChild(user_id)) {

                        Intent mainIntent = new Intent(LoginActivity.this, BlogMainActivity.class);
