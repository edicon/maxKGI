...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child(Config.BLOG_PATH);
    ...
    private void startPosting() {
        progress.setMessage("공지글을 게시합니다.");
        ...
        if (!TextUtils.isEmpty(title_val) && !TextUtils.isEmpty(desc_val) /* && imageUri != null */) {
            ...
            if( notImage ) {
                ...
                newPostRef.child("description").setValue(desc_val).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
            ...
            Toast.makeText(this, "공지 제목과 공지 내용을 입력 바랍니다.", Toast.LENGTH_LONG).show();
        }
    }
