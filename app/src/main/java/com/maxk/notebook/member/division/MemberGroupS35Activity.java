...
public class MemberGroupS35Activity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] memberDiv = MemberDivData.MemberGroupS35;
	...
	private class mainMenuOnClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			String query = MaxkUtils.getSearchText( v,  buttons, MemberDivData.MemberGroupS35Type );
			String title = MaxkUtils.findTitle( MemberDivData.MemberGroupS35, MemberDivData.MemberGroupS35Type, query);
