...
public class MemberGroupS34Activity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] memberDiv = MemberDivData.MemberGroupS34;
	...
	private class mainMenuOnClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			String query = MaxkUtils.getSearchText( v,  buttons, MemberDivData.MemberGroupS34Type );
			String title = MaxkUtils.findTitle( MemberDivData.MemberGroupS34, MemberDivData.MemberGroupS34Type, query);
